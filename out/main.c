...
typedef struct Maybe__Semver Maybe__Semver;
...
typedef struct Semver__Lambda_from_MINUS_string_154_env_ty Semver__Lambda_from_MINUS_string_154_env_ty;
...
// Depth 5
struct Semver__Lambda_from_MINUS_string_154_env_ty {
    Maybe__String tag;
};
...
#define Maybe__Semver_Just_tag 0
#define Maybe__Semver_Nothing_tag 1
...
// Depth 8
typedef Maybe__String*(*Fn__Semver_MUL__Maybe__String_MUL_)(Semver*);

// Depth 8
typedef bool(*Fn__Semver_MUL__Semver_MUL__bool)(Semver*, Semver*);

// Depth 8
typedef String(*Fn__Semver_MUL__String)(Semver*);

// Depth 8
typedef int*(*Fn__Semver_MUL__int_MUL_)(Semver*);

// Depth 8
typedef Semver(*Fn___Semver)();

// Depth 8
typedef Semver(*Fn__int_int_int_Maybe__String_Semver)(int, int, int, Maybe__String);

// Depth 8
typedef Semver(*Fn__int_int_int_Semver)(int, int, int);
...
// Depth 10
typedef bool(*Fn__Maybe__Semver_MUL__Maybe__Semver_MUL__bool)(Maybe__Semver*, Maybe__Semver*);

// Depth 10
typedef String(*Fn__Maybe__Semver_MUL__String)(Maybe__Semver*);

// Depth 10
typedef bool(*Fn__Maybe__Semver_MUL__bool)(Maybe__Semver*);

// Depth 10
typedef Maybe__Semver(*Fn__Semver_Maybe__Semver)(Semver);

// Depth 10
typedef Maybe__Semver(*Fn__String_MUL__Maybe__Semver)(String*);

// Depth 10
typedef Maybe__Semver(*Fn___Maybe__Semver)();
...
// Depth 505
typedef TestState(*Fn__TestState_MUL__Maybe__Semver_MUL__Maybe__Semver_MUL__String_MUL__String_MUL__Fn__Maybe__Semver_MUL__Maybe__Semver_MUL__bool_TestState)(TestState*, Maybe__Semver*, Maybe__Semver*, String*, String*, Lambda);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Maybe__Semver_MUL__Maybe__Semver_MUL__String_MUL__String_MUL__bool_TestState)(TestState*, Maybe__Semver*, Maybe__Semver*, String*, String*, bool);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Maybe__Semver_MUL__Maybe__Semver_MUL__String_MUL__TestState)(TestState*, Maybe__Semver*, Maybe__Semver*, String*);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Semver_MUL__Semver_MUL__String_MUL__Fn__Semver_MUL__Semver_MUL__bool_TestState)(TestState*, Semver*, Semver*, String*, Lambda);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Semver_MUL__Semver_MUL__String_MUL__String_MUL__Fn__Semver_MUL__Semver_MUL__bool_TestState)(TestState*, Semver*, Semver*, String*, String*, Lambda);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Semver_MUL__Semver_MUL__String_MUL__String_MUL__bool_TestState)(TestState*, Semver*, Semver*, String*, String*, bool);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Semver_MUL__Semver_MUL__String_MUL__TestState)(TestState*, Semver*, Semver*, String*);
...
// Depth 500
bool _DIV__EQ___Semver_MUL_(Semver* a, Semver* b);
...
// Depth 500
Semver__Lambda_from_MINUS_string_154_env_ty* Semver__Lambda_from_MINUS_string_154_env_ty_copy(Semver__Lambda_from_MINUS_string_154_env_ty* pRef);

// Depth 500
void Semver__Lambda_from_MINUS_string_154_env_ty_delete(Semver__Lambda_from_MINUS_string_154_env_ty* p);
...
// Depth 500
Array__String Array_suffix__String(Array__String* xs, int start_MINUS_index);
...
// Depth 500
void Function_delete__Maybe__Semver_MUL__Maybe__Semver_MUL__bool (Lambda f);
...
// Depth 500
void Function_delete__Semver_MUL__Semver_MUL__bool (Lambda f);
...
// Depth 500
bool Maybe__EQ___Semver(Maybe__Semver* a, Maybe__Semver* b);
...
// Depth 500
Maybe__Semver Maybe_Just__Semver(Semver member0);
...
// Depth 500
Maybe__Semver Maybe_Nothing__Semver();
...
// Depth 500
void Maybe_delete__Semver(Maybe__Semver p);
...
// Depth 500
bool Maybe_nothing_QMARK___Semver(Maybe__Semver* a);
...
// Depth 500
String Maybe_str__Semver(Maybe__Semver *p);
...
// Depth 500
bool Semver__LT_(Semver* a, Semver* b);

// Depth 500
bool Semver__EQ_(Semver* o1, Semver* o2);

// Depth 500
bool Semver__GT___Semver_MUL_(Semver* a, Semver* b);

// Depth 500
Semver Semver__Lambda_from_MINUS_string_154_env(Semver__Lambda_from_MINUS_string_154_env_ty* _env, int maj, int min, int pat);

// Depth 500
Semver Semver_copy(Semver* pRef);

// Depth 500
void Semver_delete(Semver p);

// Depth 500
Maybe__Semver Semver_from_MINUS_string(String* s);

// Depth 500
Semver Semver_init(int major, int minor, int patch, Maybe__String tag);

// Depth 500
int* Semver_major(Semver* p);

// Depth 500
int* Semver_minor(Semver* p);

// Depth 500
int* Semver_patch(Semver* p);

// Depth 500
String Semver_prn(Semver *p);

// Depth 500
Semver Semver_set_MINUS_major(Semver p, int newValue);

// Depth 500
void Semver_set_MINUS_major_BANG_(Semver* pRef, int newValue);

// Depth 500
Semver Semver_set_MINUS_minor(Semver p, int newValue);

// Depth 500
void Semver_set_MINUS_minor_BANG_(Semver* pRef, int newValue);

// Depth 500
Semver Semver_set_MINUS_patch(Semver p, int newValue);

// Depth 500
void Semver_set_MINUS_patch_BANG_(Semver* pRef, int newValue);

// Depth 500
Semver Semver_set_MINUS_tag(Semver p, Maybe__String newValue);

// Depth 500
void Semver_set_MINUS_tag_BANG_(Semver* pRef, Maybe__String newValue);

// Depth 500
String Semver_str(Semver *p);

// Depth 500
Maybe__String* Semver_tag(Semver* p);

// Depth 500
Semver Semver_update_MINUS_major(Semver p, Lambda *updater);

// Depth 500
Semver Semver_update_MINUS_minor(Semver p, Lambda *updater);

// Depth 500
Semver Semver_update_MINUS_patch(Semver p, Lambda *updater);

// Depth 500
Semver Semver_update_MINUS_tag(Semver p, Lambda *updater);
...
// Depth 500
bool SemverCopy__EQ_(Semver a, Semver b);
...
// Depth 500
TestState Test_assert_MINUS_equal__Maybe__Semver_MUL__String(TestState* state, Maybe__Semver* x, Maybe__Semver* y, String* descr);

// Depth 500
TestState Test_assert_MINUS_equal__Semver_MUL__String(TestState* state, Semver* x, Semver* y, String* descr);

// Depth 500
TestState Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(TestState* state, Semver* x, Semver* y, String* descr, Lambda op);

// Depth 500
TestState Test_display_MINUS_test__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(TestState* state, Maybe__Semver* expected, Maybe__Semver* actual, String* descr, String* what, bool is_MINUS_success);

// Depth 500
TestState Test_display_MINUS_test__Semver_MUL__Semver_MUL__String_String(TestState* state, Semver* expected, Semver* actual, String* descr, String* what, bool is_MINUS_success);

// Depth 500
void Test_handle_MINUS_signal__void(int x);

// Depth 500
TestState Test_handler__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(TestState* state, Maybe__Semver* expected, Maybe__Semver* actual, String* descr, String* what, Lambda op);

// Depth 500
TestState Test_handler__Semver_MUL__Semver_MUL__String_String(TestState* state, Semver* expected, Semver* actual, String* descr, String* what, Lambda op);
...
Array__String Array_suffix__String(Array__String* xs, int start_MINUS_index) {
    int _10 = Array_length__String(xs);
    Array__String _11 = Array_slice__String(xs, start_MINUS_index, _10);
    return _11;
}
...
bool Maybe__EQ___Semver(Maybe__Semver* a, Maybe__Semver* b) {
    bool _28;
    if(a->_tag == Maybe__Semver_Nothing_tag) {
        Maybe__Semver* _6_temp = a;
        // Case expr:
        bool _11 = Maybe_nothing_QMARK___Semver(b);
        _28 = _11;
    }
    else if(a->_tag == Maybe__Semver_Just_tag) {
        Maybe__Semver* _6_temp = a;
        Semver* x = &_6_temp->u.Just.member0;
        // Case expr:
        bool _27;
        if(b->_tag == Maybe__Semver_Nothing_tag) {
            Maybe__Semver* _16_temp = b;
            // Case expr:
            _27 = false;
        }
        else if(b->_tag == Maybe__Semver_Just_tag) {
            Maybe__Semver* _16_temp = b;
            Semver* y = &_16_temp->u.Just.member0;
            // Case expr:
            bool _26 = Semver__EQ_(x, y);
            _27 = _26;
        }
...
Maybe__Semver Maybe_Just__Semver(Semver member0) {
  Maybe__Semver instance;
    instance.u.Just.member0 = member0;
    instance._tag = Maybe__Semver_Just_tag;
    return instance;
}
...
Maybe__Semver Maybe_Nothing__Semver() {
  Maybe__Semver instance;
    ...
    instance._tag = Maybe__Semver_Nothing_tag;
    return instance;
}
...
void Maybe_delete__Semver(Maybe__Semver p) {
  if(p._tag == Maybe__Semver_Just_tag) {
    Semver_delete(p.u.Just.member0);
  }
  else if(p._tag == Maybe__Semver_Nothing_tag) {
...
bool Maybe_nothing_QMARK___Semver(Maybe__Semver* a) {
    bool _13;
    if(a->_tag == Maybe__Semver_Nothing_tag) {
        Maybe__Semver* _5_temp = a;
        // Case expr:
        _13 = true;
    }
    else if(a->_tag == Maybe__Semver_Just_tag) {
        Maybe__Semver* _5_temp = a;
        Semver* x = &_5_temp->u.Just.member0;
        // Case expr:
        _13 = false;
    }
...
String Maybe_str__Semver(Maybe__Semver *p) {
  ...
  if(p->_tag == Maybe__Semver_Just_tag) {
    size += snprintf(NULL, 0, "(%s ", "Just");
  temp = Semver_prn(&p->u.Just.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == Maybe__Semver_Nothing_tag) {
    size += snprintf(NULL, 0, "(%s ", "Nothing");
...
bool Semver__LT_(Semver* a, Semver* b) {
    bool _42;
    int* _9 = Semver_major(a);
    int* _12 = Semver_major(b);
    bool _13 = IntRef__LT_(_9, _12);
    if (_13) {
        bool _16 = true;
        _42 = _16;
    } else {
        bool _40;
        int* _22 = Semver_minor(a);
        int* _25 = Semver_minor(b);
        bool _26 = IntRef__LT_(_22, _25);
        if (_26) {
            bool _29 = true;
            _40 = _29;
        } else {
            int* _34 = Semver_patch(a);
            int* _37 = Semver_patch(b);
            bool _38 = IntRef__LT_(_34, _37);
            bool _39 = _38;
            _40 = _39;
        }
        bool _41 = _40;
...
bool Semver__EQ_(Semver* o1, Semver* o2) {
    bool _65;
    Maybe__String* _9 = Semver_tag(o1);
    Maybe__String* _12 = Semver_tag(o2);
    bool _13 = Maybe__EQ___String(_9, _12);
    if (_13) {
        bool _60;
        int* _19 = Semver_patch(o1);
        int* _22 = Semver_patch(o2);
        bool _23 = IntRef__EQ_(_19, _22);
        if (_23) {
            bool _55;
            int* _29 = Semver_minor(o1);
            int* _32 = Semver_minor(o2);
            bool _33 = IntRef__EQ_(_29, _32);
            if (_33) {
                bool _50;
                int* _39 = Semver_major(o1);
                int* _42 = Semver_major(o2);
                bool _43 = IntRef__EQ_(_39, _42);
                if (_43) {
                    bool _46 = true;
                    _50 = _46;
                } else {
...
bool Semver__GT___Semver_MUL_(Semver* a, Semver* b) {
    bool _8 = Semver__LT_(b, a);
    return _8;
}

Semver Semver__Lambda_from_MINUS_string_154_env(Semver__Lambda_from_MINUS_string_154_env_ty* _env, int maj, int min, int pat) {
    Maybe__String* _151 = &_env->tag; // ref
    Maybe__String _152 = Maybe_copy__String(_151);
    Semver _153 = Semver_init(maj, min, pat, _152);
    return _153;
}

Semver Semver_copy(Semver* pRef) {
    Semver copy = *pRef;
    /* Ignore non-managed member 'major' : Int */
    /* Ignore non-managed member 'minor' : Int */
    /* Ignore non-managed member 'patch' : Int */
    copy.tag = Maybe_copy__String(&(pRef->tag));
    return copy;
}
...
void Semver_delete(Semver p) {
    ...
    /* Ignore non-managed member 'minor' : Int */
    /* Ignore non-managed member 'patch' : Int */
    Maybe_delete__String(p.tag);
}

Maybe__Semver Semver_from_MINUS_string(String* s) {
    Maybe__Semver _171;
    int _9 = String_count_MINUS_char(s, 46/*'.'*/);
    bool _11 = Int__GT_(_9, 1);
    if (_11) {
        Maybe__Semver _165;
        /* let */ {
            Array _19 = { .len = 1, .capacity = 1, .data = CARP_MALLOC(sizeof(Char) * 1) };
            ((Char*)_19.data)[0] = 46/*'.'*/;
            Array__Char* _20 = &_19; // ref
            Array__String _21 = String_split_MINUS_by(s, _20);
            Array__String split = _21;
            Array__String* _27 = &split; // ref
            String* _29 = Array_unsafe_MINUS_nth__String(_27, 0);
            Maybe__int _30 = Int_from_MINUS_string(_29);
            Maybe__int major = _30;
            Array__String* _36 = &split; // ref
            String* _38 = Array_unsafe_MINUS_nth__String(_36, 1);
            Maybe__int _39 = Int_from_MINUS_string(_38);
            Maybe__int minor = _39;
            static String _42 = ".";
            String *_42_ref = &_42;
            Array__String* _47 = &split; // ref
            Array__String _49 = Array_suffix__String(_47, 2);
            Array__String* _50 = &_49; // ref
            String _51 = String_join(_42_ref, _50);
            String trail = _51;
            static String _54 = "[^0-9]";
            String *_54_ref = &_54;
            String* _57 = &trail; // ref
            int _58 = Pattern_find(_54_ref, _57);
            int idx = _58;
            String _80;
            bool _64 = Int__GT_(idx, -1);
            if (_64) {
                String* _69 = &trail; // ref
                String _71 = String_prefix(_69, idx);
                String _72 = _71;
                _80 = _72;
            } else {
                String* _77 = &trail; // ref
                String _78 = String_copy(_77);
                String _79 = _78;
                _80 = _79;
            }
            String patch_MINUS_str = _80;
            String* _85 = &patch_MINUS_str; // ref
            Maybe__int _86 = Int_from_MINUS_string(_85);
            Maybe__int patch = _86;
            Maybe__String _107;
            bool _92 = Int__GT_(idx, -1);
            if (_92) {
                String* _98 = &trail; // ref
                String _100 = String_suffix(_98, idx);
                Maybe__String _101 = Maybe_Just__String(_100);
                Maybe__String _102 = _101;
                _107 = _102;
            } else {
                Maybe__String _105 = Maybe_Nothing__String();
                Maybe__String _106 = _105;
                _107 = _106;
            }
            Maybe__String tag = _107;
            Maybe__Semver _1000011;
            if(major._tag == Maybe__int_Nothing_tag) {
                Maybe__int _110_temp = major;
                // Case expr:
                Maybe__Semver _1000014 = Maybe_Nothing__Semver();
                _1000011 = _1000014;
                Maybe_delete__int(minor);
                Maybe_delete__int(patch);
            }
            else if(major._tag == Maybe__int_Just_tag) {
                Maybe__int _110_temp = major;
                int zip1039 = _110_temp.u.Just.member0;
                // Case expr:
                Maybe__Semver _1000016;
                if(minor._tag == Maybe__int_Nothing_tag) {
                    Maybe__int _119_temp = minor;
                    // Case expr:
                    Maybe__Semver _1000019 = Maybe_Nothing__Semver();
                    _1000016 = _1000019;
                    Maybe_delete__int(patch);
                }
                else if(minor._tag == Maybe__int_Just_tag) {
                    Maybe__int _119_temp = minor;
                    int zip1040 = _119_temp.u.Just.member0;
                    // Case expr:
                    Maybe__Semver _1000021;
                    if(patch._tag == Maybe__int_Nothing_tag) {
                        Maybe__int _128_temp = patch;
                        // Case expr:
                        Maybe__Semver _1000024 = Maybe_Nothing__Semver();
                        _1000021 = _1000024;
                    }
                    else if(patch._tag == Maybe__int_Just_tag) {
                        Maybe__int _128_temp = patch;
                        int zip1041 = _128_temp.u.Just.member0;
                        // Case expr:
                        // This lambda captures 1 variables: tag
                        Semver__Lambda_from_MINUS_string_154_env_ty *_154_env = CARP_MALLOC(sizeof(Semver__Lambda_from_MINUS_string_154_env_ty));
                        _154_env->tag = tag;
                        Lambda _154 = {
                          .callback = (void*)Semver__Lambda_from_MINUS_string_154_env,
                          .env = _154_env,
                          .delete = (void*)Semver__Lambda_from_MINUS_string_154_env_ty_delete,
                          .copy = (void*)Semver__Lambda_from_MINUS_string_154_env_ty_copy
                        };
                        Lambda* _155 = &_154; // ref
                        Semver _1000027 = (*_155).env ? ((Semver(*)(LambdaEnv, int, int, int))(*_155).callback)((*_155).env, zip1039, zip1040, zip1041) : ((Semver(*)(int, int, int))(*_155).callback)(zip1039, zip1040, zip1041);
                        Maybe__Semver _1000026 = Maybe_Just__Semver(_1000027);
                        _1000021 = _1000026;
                    }
                    else UNHANDLED("semver.carp", 20);
                    _1000016 = _1000021;
                }
                else UNHANDLED("semver.carp", 20);
                _1000011 = _1000016;
            ...
            _165 = _1000011;
            Array_delete__Char(_19);
            Array_delete__String(_49);
            Array_delete__String(split);
            Maybe_delete__String(tag);
            String_delete(patch_MINUS_str);
            String_delete(trail);
        }
        Maybe__Semver _166 = _165;
        _171 = _166;
    } else {
        Maybe__Semver _169 = Maybe_Nothing__Semver();
        Maybe__Semver _170 = _169;
        _171 = _170;
    }
    return _171;
}
...
int* Semver_major(Semver* p) { return (&(p->major)); }

int* Semver_minor(Semver* p) { return (&(p->minor)); }

int* Semver_patch(Semver* p) { return (&(p->patch)); }
...
String Semver_prn(Semver *p) {
  ...
  int tempsize = 0;
  (void)tempsize; // that way we remove the occasional unused warning 
  int size = snprintf(NULL, 0, "(%s )", "Semver");
  temp = Int_prn(p->major); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  temp = Int_prn(p->minor); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  temp = Int_prn(p->patch); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  temp = Maybe_prn__String(&p->tag); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Semver");
  temp = Int_prn(p->major);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
...
Maybe__String* Semver_tag(Semver* p) { return (&(p->tag)); }

Semver Semver_update_MINUS_major(Semver p, Lambda *updater) {
    p.major = (*updater).env ? ((Fn__LambdaEnv_int_int)(*updater).callback)((*updater).env, p.major) : ((Fn__int_int)(*updater).callback)(p.major);
    return p;
}


Semver Semver_update_MINUS_minor(Semver p, Lambda *updater) {
    p.minor = (*updater).env ? ((Fn__LambdaEnv_int_int)(*updater).callback)((*updater).env, p.minor) : ((Fn__int_int)(*updater).callback)(p.minor);
    return p;
}


Semver Semver_update_MINUS_patch(Semver p, Lambda *updater) {
    p.patch = (*updater).env ? ((Fn__LambdaEnv_int_int)(*updater).callback)((*updater).env, p.patch) : ((Fn__int_int)(*updater).callback)(p.patch);
    return p;
}


Semver Semver_update_MINUS_tag(Semver p, Lambda *updater) {
    p.tag = (*updater).env ? ((Fn__LambdaEnv_Maybe__String_Maybe__String)(*updater).callback)((*updater).env, p.tag) : ((Fn__Maybe__String_Maybe__String)(*updater).callback)(p.tag);
    return p;
}


Semver Semver_zero() {
    Maybe__String _8 = Maybe_Nothing__String();
    Semver _9 = Semver_init(0, 0, 0, _8);
    return _9;
}
...
Semver__Lambda_from_MINUS_string_154_env_ty* Semver__Lambda_from_MINUS_string_154_env_ty_copy(Semver__Lambda_from_MINUS_string_154_env_ty* pRef) {
    Semver__Lambda_from_MINUS_string_154_env_ty* copy = CARP_MALLOC(sizeof(*pRef));
    *copy = *pRef;
    copy->tag = Maybe_copy__String(&(pRef->tag));
    return copy;
}
...
TestState Test_assert_MINUS_equal__Maybe__Semver_MUL__String(TestState* state, Maybe__Semver* x, Maybe__Semver* y, String* descr) {
    ...
    String *_12_ref = &_12;
    Lambda _13 = { .callback = (void*)Maybe__EQ___Semver, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Maybe.=__Semver (LookupGlobal CarpLand AFunction)
    TestState _14 = Test_handler__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(state, x, y, descr, _12_ref, _13);
    return _14;
}
...
TestState Test_assert_MINUS_equal__Semver_MUL__String(TestState* state, Semver* x, Semver* y, String* descr) {
    static String _12 = "value";
    String *_12_ref = &_12;
    Lambda _13 = { .callback = (void*)Semver__EQ_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.= (LookupGlobal CarpLand AFunction)
    TestState _14 = Test_handler__Semver_MUL__Semver_MUL__String_String(state, x, y, descr, _12_ref, _13);
    return _14;
}

TestState Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(TestState* state, Semver* x, Semver* y, String* descr, Lambda op) {
    static String _13 = "value";
    String *_13_ref = &_13;
    TestState _15 = Test_handler__Semver_MUL__Semver_MUL__String_String(state, x, y, descr, _13_ref, op);
    return _15;
}
...
TestState Test_display_MINUS_test__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(TestState* state, Maybe__Semver* expected, Maybe__Semver* actual, String* descr, String* what, bool is_MINUS_success) {
    ...
    if (is_MINUS_success) {
        ...
        IO_print(_131);
        String _137 = Maybe_str__Semver(expected);
        ...
        String _158 = Maybe_str__Semver(actual);
...
TestState Test_display_MINUS_test__Semver_MUL__Semver_MUL__String_String(TestState* state, Semver* expected, Semver* actual, String* descr, String* what, bool is_MINUS_success) {
    ...
    if (is_MINUS_success) {
        ...
        String* _131 = &_1000027; // ref
        IO_print(_131);
        String _137 = Semver_str(expected);
        String* _138 = &_137; // ref
        IO_print(_138);
        static String _148 = "', actual value: '";
        String *_148_ref = &_148;
...
TestState Test_handler__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(TestState* state, Maybe__Semver* expected, Maybe__Semver* actual, String* descr, String* what, Lambda op) {
    bool _18 = op.env ? ((bool(*)(LambdaEnv, Maybe__Semver*, Maybe__Semver*))op.callback)(op.env, expected, actual) : ((bool(*)(Maybe__Semver*, Maybe__Semver*))op.callback)(expected, actual);
    TestState _19 = Test_display_MINUS_test__Maybe__Semver_MUL__Maybe__Semver_MUL__String_String(state, expected, actual, descr, what, _18);
    Function_delete__Maybe__Semver_MUL__Maybe__Semver_MUL__bool(op);
    return _19;
}

TestState Test_handler__Semver_MUL__Semver_MUL__String_String(TestState* state, Semver* expected, Semver* actual, String* descr, String* what, Lambda op) {
    bool _18 = op.env ? ((bool(*)(LambdaEnv, Semver*, Semver*))op.callback)(op.env, expected, actual) : ((bool(*)(Semver*, Semver*))op.callback)(expected, actual);
    TestState _19 = Test_display_MINUS_test__Semver_MUL__Semver_MUL__String_String(state, expected, actual, descr, what, _18);
    Function_delete__Semver_MUL__Semver_MUL__bool(op);
    return _19;
}
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        static String _25 = "-tag";
        String *_25_ref = &_25;
        String _26 = String_copy(_25_ref);
        Maybe__String _27 = Maybe_Just__String(_26);
        Semver _28 = Semver_init(1, 2, 3, _27);
        Semver* _29 = &_28; // ref
        static String _37 = "-tag";
        String *_37_ref = &_37;
        String _38 = String_copy(_37_ref);
        Maybe__String _39 = Maybe_Just__String(_38);
        Semver _40 = Semver_init(1, 2, 3, _39);
        Semver* _41 = &_40; // ref
        static String _42 = "semantic versions can be tested for equality";
        String *_42_ref = &_42;
        Lambda _43 = { .callback = (void*)Semver__EQ_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.= (LookupGlobal CarpLand AFunction)
        TestState _44 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _29, _41, _42_ref, _43);
        TestState* _1000011 = &_44; // ref
        test = _1000011;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _59 = "-tag";
        String *_59_ref = &_59;
        String _60 = String_copy(_59_ref);
        Maybe__String _61 = Maybe_Just__String(_60);
        Semver _62 = Semver_init(1, 2, 3, _61);
        Semver* _63 = &_62; // ref
        Maybe__String _70 = Maybe_Nothing__String();
        Semver _71 = Semver_init(1, 2, 3, _70);
        Semver* _72 = &_71; // ref
        static String _73 = "semantic versions can be tested for equality";
        String *_73_ref = &_73;
        Lambda _74 = { .callback = (void*)_DIV__EQ___Semver_MUL_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym /=__Semver* (LookupGlobal CarpLand AFunction)
        TestState _75 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _63, _72, _73_ref, _74);
        TestState* _1000014 = &_75; // ref
        test = _1000014;  // (Ref Test.State r271) = (Ref Test.State r271)
        Maybe__String _90 = Maybe_Nothing__String();
        Semver _91 = Semver_init(1, 2, 3, _90);
        Maybe__Semver _92 = Maybe_Just__Semver(_91);
        Maybe__Semver* _93 = &_92; // ref
        static String _96 = "1.2.3";
        String *_96_ref = &_96;
        Maybe__Semver _97 = Semver_from_MINUS_string(_96_ref);
        Maybe__Semver* _98 = &_97; // ref
        static String _99 = "simple semantic version parses correctly";
        String *_99_ref = &_99;
        TestState _100 = Test_assert_MINUS_equal__Maybe__Semver_MUL__String(test, _93, _98, _99_ref);
        TestState* _1000017 = &_100; // ref
        test = _1000017;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _116 = "-tag";
        String *_116_ref = &_116;
        String _117 = String_copy(_116_ref);
        Maybe__String _118 = Maybe_Just__String(_117);
        Semver _119 = Semver_init(1, 2, 3, _118);
        Maybe__Semver _120 = Maybe_Just__Semver(_119);
        Maybe__Semver* _121 = &_120; // ref
        static String _124 = "1.2.3-tag";
        String *_124_ref = &_124;
        Maybe__Semver _125 = Semver_from_MINUS_string(_124_ref);
        Maybe__Semver* _126 = &_125; // ref
        static String _127 = "semantic version with tag parses correctly";
        String *_127_ref = &_127;
        TestState _128 = Test_assert_MINUS_equal__Maybe__Semver_MUL__String(test, _121, _126, _127_ref);
        TestState* _1000020 = &_128; // ref
        test = _1000020;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _143 = "-tag";
        String *_143_ref = &_143;
        String _144 = String_copy(_143_ref);
        Maybe__String _145 = Maybe_Just__String(_144);
        Semver _146 = Semver_init(1, 2, 3, _145);
        Semver* _147 = &_146; // ref
        static String _155 = "-tag";
        String *_155_ref = &_155;
        String _156 = String_copy(_155_ref);
        Maybe__String _157 = Maybe_Just__String(_156);
        Semver _158 = Semver_init(1, 2, 4, _157);
        Semver* _159 = &_158; // ref
        static String _160 = "semantic versions can be compared with < I";
        String *_160_ref = &_160;
        Lambda _161 = { .callback = (void*)Semver__LT_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.< (LookupGlobal CarpLand AFunction)
        TestState _162 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _147, _159, _160_ref, _161);
        TestState* _1000023 = &_162; // ref
        test = _1000023;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _177 = "-tag";
        String *_177_ref = &_177;
        String _178 = String_copy(_177_ref);
        Maybe__String _179 = Maybe_Just__String(_178);
        Semver _180 = Semver_init(1, 2, 3, _179);
        Semver* _181 = &_180; // ref
        static String _189 = "-tag";
        String *_189_ref = &_189;
        String _190 = String_copy(_189_ref);
        Maybe__String _191 = Maybe_Just__String(_190);
        Semver _192 = Semver_init(1, 3, 0, _191);
        Semver* _193 = &_192; // ref
        static String _194 = "semantic versions can be compared with < II";
        String *_194_ref = &_194;
        Lambda _195 = { .callback = (void*)Semver__LT_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.< (LookupGlobal CarpLand AFunction)
        TestState _196 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _181, _193, _194_ref, _195);
        TestState* _1000026 = &_196; // ref
        test = _1000026;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _211 = "-tag";
        String *_211_ref = &_211;
        String _212 = String_copy(_211_ref);
        Maybe__String _213 = Maybe_Just__String(_212);
        Semver _214 = Semver_init(1, 2, 3, _213);
        Semver* _215 = &_214; // ref
        static String _223 = "-tag";
        String *_223_ref = &_223;
        String _224 = String_copy(_223_ref);
        Maybe__String _225 = Maybe_Just__String(_224);
        Semver _226 = Semver_init(2, 0, 0, _225);
        Semver* _227 = &_226; // ref
        static String _228 = "semantic versions can be compared with < III";
        String *_228_ref = &_228;
        Lambda _229 = { .callback = (void*)Semver__LT_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.< (LookupGlobal CarpLand AFunction)
        TestState _230 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _215, _227, _228_ref, _229);
        TestState* _1000029 = &_230; // ref
        test = _1000029;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _245 = "-tag";
        String *_245_ref = &_245;
        String _246 = String_copy(_245_ref);
        Maybe__String _247 = Maybe_Just__String(_246);
        Semver _248 = Semver_init(1, 2, 4, _247);
        Semver* _249 = &_248; // ref
        static String _257 = "-tag";
        String *_257_ref = &_257;
        String _258 = String_copy(_257_ref);
        Maybe__String _259 = Maybe_Just__String(_258);
        Semver _260 = Semver_init(1, 2, 3, _259);
        Semver* _261 = &_260; // ref
        static String _262 = "semantic versions can be compared with > I";
        String *_262_ref = &_262;
        Lambda _263 = { .callback = (void*)Semver__GT___Semver_MUL_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.>__Semver* (LookupGlobal CarpLand AFunction)
        TestState _264 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _249, _261, _262_ref, _263);
        TestState* _1000032 = &_264; // ref
        test = _1000032;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _279 = "-tag";
        String *_279_ref = &_279;
        String _280 = String_copy(_279_ref);
        Maybe__String _281 = Maybe_Just__String(_280);
        Semver _282 = Semver_init(1, 3, 0, _281);
        Semver* _283 = &_282; // ref
        static String _291 = "-tag";
        String *_291_ref = &_291;
        String _292 = String_copy(_291_ref);
        Maybe__String _293 = Maybe_Just__String(_292);
        Semver _294 = Semver_init(1, 2, 3, _293);
        Semver* _295 = &_294; // ref
        static String _296 = "semantic versions can be compared with > II";
        String *_296_ref = &_296;
        Lambda _297 = { .callback = (void*)Semver__GT___Semver_MUL_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.>__Semver* (LookupGlobal CarpLand AFunction)
        TestState _298 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _283, _295, _296_ref, _297);
        TestState* _1000035 = &_298; // ref
        test = _1000035;  // (Ref Test.State r271) = (Ref Test.State r271)
        static String _313 = "-tag";
        String *_313_ref = &_313;
        String _314 = String_copy(_313_ref);
        Maybe__String _315 = Maybe_Just__String(_314);
        Semver _316 = Semver_init(2, 0, 0, _315);
        Semver* _317 = &_316; // ref
        static String _325 = "-tag";
        String *_325_ref = &_325;
        String _326 = String_copy(_325_ref);
        Maybe__String _327 = Maybe_Just__String(_326);
        Semver _328 = Semver_init(1, 2, 3, _327);
        Semver* _329 = &_328; // ref
        static String _330 = "semantic versions can be compared with > III";
        String *_330_ref = &_330;
        Lambda _331 = { .callback = (void*)Semver__GT___Semver_MUL_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Semver.>__Semver* (LookupGlobal CarpLand AFunction)
        TestState _332 = Test_assert_MINUS_op__Semver_MUL__Semver_MUL__String(test, _317, _329, _330_ref, _331);
        TestState* _1000038 = &_332; // ref
        test = _1000038;  // (Ref Test.State r271) = (Ref Test.State r271)
        Maybe__String _346 = Maybe_Nothing__String();
        Semver _347 = Semver_init(0, 0, 0, _346);
        Semver* _348 = &_347; // ref
        Semver _351 = Semver_zero();
        Semver* _352 = &_351; // ref
        static String _353 = "semantic versions can be created by zero";
        String *_353_ref = &_353;
        TestState _354 = Test_assert_MINUS_equal__Semver_MUL__String(test, _348, _352, _353_ref);
        TestState* _1000041 = &_354; // ref
        test = _1000041;  // (Ref Test.State r271) = (Ref Test.State r271)
        ...
        _1000003 = _1000007;
        Maybe_delete__Semver(_120);
        Maybe_delete__Semver(_125);
        Maybe_delete__Semver(_92);
        Maybe_delete__Semver(_97);
        Semver_delete(_146);
        Semver_delete(_158);
        Semver_delete(_180);
        Semver_delete(_192);
        ...
        Semver_delete(_62);
        Semver_delete(_71);
        Test_State_delete(_100);
        Test_State_delete(_1000006);
        Test_State_delete(_128);
        Test_State_delete(_162);
        Test_State_delete(_196);
        Test_State_delete(_230);
        Test_State_delete(_264);
        Test_State_delete(_298);
        Test_State_delete(_332);
        Test_State_delete(_354);
        Test_State_delete(_44);
        Test_State_delete(_75);
    }
    return _1000003;
}
